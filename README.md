...
一个用于 Claude / Codex / OpenClaw / Hermes Agent 等Agent 的 HTML 设计工件生成 Skill。给出设计需求，输出精良的 HTML 设计稿。

## 使用方式

将 `SKILL.md` 放入你的 Agent 项目 `kit-design` 目录，或直接作为 Skill 导入。
...
A Agent skill for generating high-quality HTML design artifacts. Describe what you need, get a polished HTML output.

## Usage

Place `SKILL.md` in your Agent project under `kit-design`, or import it directly as a skill.
